...
const RenderCard = ({ data, title }) => {
    ...
    return <h2 className="mt-5 font-bold text-[#6449ff] text-lg uppercase">{title}</h2>;
};
...
const Home = () => {
    ...
    return (
        <section className="max-w-7xl mx-auto">
            <Heading
                h1="The Community Showcase"
                p="Browse through a collection of imaginative and visually stunning images generated by DALL-E AI"
            />
