...
import { FormField, Heading, Loader } from "../components";
...
const CreatePost = () => {
    ...
    return (
        <section className="max-w-7xl mx-auto">
            <Heading
                h1="Create"
                p="Create imaginative and visually stunning images through by DALL-E AI and share them with the community"
            />
